        ...
        <div className='form_footer'>
            <div className='list_footer'>
                <div className='list_footer_item'>
                    ...
                    <ul className='footer_link'>
                        <li><a href='#'>Giới thiệu về Shop Trẻ Thơ</a></li>
                        <li><a href='#'>Hệ thống cửa hàng</a></li>
                        <li><a href='#'>Liên hệ & góp ý</a></li>
                        <li><a href='#'>Tuyển dụng </a></li>
                        <li><a href='#'>Mua sỉ/mua buôn</a></li>
                        <li><a href='#'>Hoạt động thiện nguyện</a></li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    <h3><b>TỔNG ĐÀI BÁN HÀNG</b></h3>
                    <p>Đặt hàng gọi miễn phí</p>
                    <p><a>1800 6066</a>(8h - 21h30)</p>
                    <p>Đổi hàng, bảo hành, khiếu nại:</p>
                    <p><a>1900 6483</a>(8h - 17h00)</p>
                </div>
                <div>
                    <h3><b>ĐĂNG KÝ NHẬN TIN KHUYẾN MẠI</b></h3>
                    <Search
            ...
            <div className='footer_end'>
                <div className='footer_end_item'>
                    <p>© 2021 ShopTreTho.com.vn - Thiên đường cho bé! GPĐKKD số 0104406702 do sở KHĐT TP.Hà Nội cấp ngày 28/01/2010
                        <br/> VPGD: 229/66 Tây Thạnh, Phường Tây Thạnh, Quận Tân Phú, Thành phố Hồ Chí Minh</p>
                </div>
